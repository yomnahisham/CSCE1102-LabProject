...
public:
    ...
    void setupUi(QDialog *LoginWindow)
    {
        ...
        loginB->setGeometry(QRect(40, 170, 100, 32));
        regB = new QPushButton(LoginWindow);
        regB->setObjectName("regB");
        regB->setGeometry(QRect(250, 170, 100, 32));
